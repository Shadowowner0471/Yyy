...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: https://t.me/+lDd2AD8SJUIxMjY1"
    bot.reply_to(message, response)
...
Buy From :- @SHARP_X_OWNER
Official Channel :- https://t.me/+lDd2AD8SJUIxMjY1
'''
...
✅Join :- https://t.me/+lDd2AD8SJUIxMjY1'''
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/+lDd2AD8SJUIxMjY1 OTHERWISE NOT WORK
